...
define(function () {
   ...
   * @param {object}
   *          obj an object
   * @return {array} a new stack with obj on top or undefined if obj is already
   *          present
   */
   ...
   * 
   * @return {object} a bistack for use with getBiStack
   */
   ...
   * @param {object}
   *          obj
   * @return {object} undefined if an infinite recursion is detected, an
   ...
   * @return {boolean} true if str is all caps, false otherwise
   */
   ...
   * @return {string} a newline-separated string of errors. "" on success
   */
   ...
   * @return {Array} a tight-packed array with unique values
   * 
   ...
   * @param {array}
   *          b, the second array
   * @return {object} an object containing the unique keys for each array
   * 
   * TODO extract to my own array library
   */
   ...
   * @return {string array} an array of all referenced keys
   */
   ...
   * @param {object}
   *          stack a stack for infinite loop avoidance
   * @return {array} an array of effective interfaces
   */
   ...
   * 
   * @return {string} a newline-separated string of errors
   */
   ...
   * @param {Interface}
   *          intf A candidate for an interface
   * @return {string} a newline-separated string with error description. "" on
   *          match.
   */
   ...
   * @return {Interface} a combined interface
   */
