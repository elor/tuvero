...
define(
    ...
    function(extend, RankingDataListener, VectorModel, Options) {
       ...
       *
       * We cannot make the assumption that there's only one opponent. That's
       * why we iterate over every team as a possible opponent and apply his
       * points to every other team's lostpoints vector.
       *
       * @param r
      ...
      RankingLostPointsListener.prototype.oncorrect = function(r, e, correction) {
        console
            .error('RankingLostPointsListener.oncorrect() not implemented yet');
      };
