 ...
 */
define(
    ['./rankinglostpointslistener', './rankingpointslistener',
        ...
        './rankingheadtoheadmatrixlistener', './rankingnumgameslistener'],
    function() {
       ...
       *
       * @param dependencies
       *          Where new dependencies are added to and the dependencies are
       *          read from
       */
       ...
       * @param output
       *          an output array which to push the names to, if their
       *          dependencies are in
      ...
      /**
       * order the names by their dependencies inplace, i.e. without creating a
...
;
        ...
        if (input.length > 0) {
          console.error('dependencies could not be resolved: ['
              + input.join(',') + ']');
          names.splice(0);
          return false;
        }
      ...
      /**
       * order the names by their dependencies and register every DataListener,
       * if available. Aborts otherwise
       *
       * @param names
