...
define(function() {
  return function(QUnit, getModule) {
    ...
    QUnit.test('RLE', function() {
      ...
      QUnit.equal(RLE.encode([0]), '', 'RLE.encode() with [0]');
      ...
      QUnit.equal(RLE.encode([undefined, null, 0]), '',
      ...
      QUnit.deepEqual(RLE.decode('[n3,1,n]'), exp,
          'RLE decode test with single null entry');
      QUnit.deepEqual(RLE.decode('[n12345]'), [],
          'RLE decode test with only null entries');
      QUnit.deepEqual(RLE.decode('[n123,n456]'), [],
      ...
      exp[3][8] = 9;
      exp[3][9] = [10];
      QUnit.deepEqual(RLE.decode('[1,[2,n3,4],[5,[6,n7]],[n8,9,[10]]]'), exp,
