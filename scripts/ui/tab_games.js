define(
    [ './team', './toast', './strings', './tab_teams', './swiss',
        './tab_ranking' ],
    function (Team, Toast, Strings, Tab_Teams, Swiss, Tab_Ranking) {
      var Tab_Games, games, $games;
      ...
      $(function ($) {
        var $closeregistration, $stages, $tpl, $tplnames, $tplnos, $anchor, $vtpl, $vanchors, $vnames, $vno, $vcontainers, isInt;
