...
function MatchResult(match, score) {
  MatchResult.superconstructor.call(this, match && match.teams, match && match.id, match && match.group);
...
MatchResult.prototype.SAVEFORMAT = Object.create(MatchModel.superclass.SAVEFORMAT);
