...
define([ '../kotournament', '../game', '../tournament', '../../lib/implements' ], function (KOTournament, Game, Tournament, Interface) {
  QUnit.test("KOTournament", function () {
    ...
    return;
    st = new KOTournament();
    QUnit.equal(st.state, KOTournament.state.preparing || 0, 'initial state is 0 (preparing)');
    ...
    QUnit.equal(st.state, KOTournament.state.running || 1, 'running state is 1 (running)');
