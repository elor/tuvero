...
define(function () {
  return function (QUnit, getModule) {
    ...
    QUnit.test("NettoRanking", function () {
      ...
      QUnit.equal(Implements(Ranking), '', 'Ranking interface validation');
      QUnit.equal(Implements(Ranking, Netto, 'rfm'), '', 'NettoRanking interface match');
    ...
    QUnit.test("BuchholzRanking", function () {
      ...
      QUnit.equal(Implements(Ranking), '', 'Ranking interface validation');
      QUnit.equal(Implements(Ranking, Buchholz, 'rfm'), '', 'BuchholzRanking interface match');
    ...
    QUnit.test("Finebuchholz", function () {
      ...
      QUnit.equal(Implements(Ranking), '', 'Ranking interface validation');
      QUnit.equal(Implements(Ranking, Finebuchholz, 'rfm'), '', 'FinebuchholzRanking interface match');
